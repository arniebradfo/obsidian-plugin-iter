...
- **Model Suggestions**: Autocomplete support for model selection in every block.

## How to use
1. Install the plugin and configure your API keys in settings.
2. Open a note and run the command **"Initialize AI Notebook"** (or click the plus icon in the ribbon).
3. Type your prompt and hit **Ctrl+Enter** or click **Submit to AI**.
